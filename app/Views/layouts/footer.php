      ...
      <div class="col-md-6 col-lg-4 mb-4 text-md-end">
        ...
        <div class="d-flex justify-content-md-end gap-3">
          <a href="https://id.linkedin.com/company/all-data-international" target="_blank" rel="noopener"
            class="social-icon"><img src="<?= base_url('assets/icon-filled/info-linkedin-filled.svg') ?>" alt=""></a>
          <a href="https://instagram.com/alldataint" target="_blank" rel="noopener"
            class="social-icon"><img src="<?= base_url('assets/icon-filled/info-instagram-filled.svg') ?>" alt=""></a>
          <a href="https://facebook.com/alldataint" target="_blank" rel="noopener"
            class="social-icon"><img src="<?= base_url('assets/icon-filled/info-facebook-filled.svg') ?>" alt=""></a>
        </div>
      </div>
    </div>
