<section id="services-section" class="py-5 position-relative">
  ...
  <div class="container text-center text-white">
    ...
    <div class="row g-4 justify-content-center">
      <!-- Card 1 -->
      <div class="col-md-4">
        <a href="<?= base_url('services/consulting'); ?>" class="text-decoration-none">
      ...
      <!-- Card 2 -->
      <div class="col-md-4">
        <a href="<?= base_url('services/use-case-development'); ?>" class="text-decoration-none">
          <div class="service-card card border-0 shadow-sm rounded-4 h-100">
            <div class="card-img-top position-relative overflow-hidden rounded-top-4">
      ...
      <!-- Card 3 -->
      <div class="col-md-4">
        <a href="<?= base_url('services/maintenance-support'); ?>" class="text-decoration-none">
          <div class="service-card card border-0 shadow-sm rounded-4 h-100">
            <div class="card-img-top position-relative overflow-hidden rounded-top-4">
      ...
      <!-- Card 4 -->
      <div class="col-md-6">
        <a href="<?= base_url('services/managed-services'); ?>" class="text-decoration-none">
          <div class="service-card card border-0 shadow-sm rounded-4 h-100">
            <div class="card-img-top position-relative overflow-hidden rounded-top-4">
      ...
      <!-- Card 5 -->
      <div class="col-md-6">
        <a href="<?= base_url('services/training'); ?>" class="text-decoration-none">
          <div class="service-card card border-0 shadow-sm rounded-4 h-100">
            <div class="card-img-top position-relative overflow-hidden rounded-top-4">
    ...
    <div class="mt-5">
      <a href="/contact" class="btn btn-hover-grow btn-light btn-lg rounded-pill px-4 py-2 shadow-sm">
