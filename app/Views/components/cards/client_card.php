<div class="container-fluid my-5 py-5 text-center client-appear" data-aos="fade-up">
  <p class="text-muted mb-6">
    Trusted by Clients Across Industries as a Technology Partner,
    <a href="company/our-clients" class="text-primary text-decoration-none">
      More Clients <svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
