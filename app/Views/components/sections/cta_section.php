            ...
            <div class="col-lg-10">
                <div class="cta-card position-relative rounded-4 p-5 text-center text-white overflow-hidden">
                    ...
                    <div class="position-absolute bottom-0 start-0 w-100" style="height: 120px; margin-bottom: -2px;">
                        <svg class="w-100 h-100" viewBox="0 0 1200 120" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
                            <path d="M0,80 Q100,40 200,80 T400,80 T600,80 T800,80 T1000,80 T1200,80 L1200,120 L0,120 Z" fill="rgba(255,255,255,0.15)" />
                            <path d="M0,90 Q150,60 300,90 T600,90 T900,90 T1200,90 L1200,120 L0,120 Z" fill="rgba(255,255,255,0.1)" />
                            <path d="M0,100 Q200,70 400,100 T800,100 T1200,100 L1200,120 L0,120 Z" fill="rgba(255,255,255,0.08)" />
                        </svg>
                    </div>
