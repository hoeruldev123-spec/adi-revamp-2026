...
<body class="bg-slate-50 text-slate-800 font-sans antialiased">
    ...
    <header class="sticky top-0 z-50 bg-huawei-dark/95 backdrop-blur border-b border-slate-800 text-white transition-all duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="https://forms.cloud.microsoft/r/u7FT0jDgdB" target="_blank" rel="noopener noreferrer" class="bg-huawei-red hover:bg-red-700 text-white px-4 py-2 rounded text-sm font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-red-600/30">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div class="lg:col-span-7 space-y-6">
                    ...
                    <div class="flex flex-wrap items-center gap-4 pt-4">
                        <a href="https://forms.cloud.microsoft/r/u7FT0jDgdB" target="_blank" rel="noopener noreferrer" class="bg-huawei-red hover:bg-red-700 text-white px-6 py-3 rounded-md font-semibold transition-all duration-300 transform hover:-translate-y-0.5 shadow-md shadow-red-500/20">
                            <?php echo $t['btn_register']; ?>
                        </a>
    ...
    <section class="bg-huawei-muted text-white py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="https://forms.cloud.microsoft/r/u7FT0jDgdB" target="_blank" rel="noopener noreferrer" class="inline-block bg-red-700 hover:bg-red-800 text-white font-bold px-8 py-3 rounded-md transition-all duration-300 text-sm uppercase tracking-wider transform hover:scale-105">
