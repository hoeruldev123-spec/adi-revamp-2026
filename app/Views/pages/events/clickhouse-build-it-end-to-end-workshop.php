...
$copy = [
    'en' => [
        ...
        'thanksBody' => 'We will confirm your seat by email within two working days, along with setup instructions for the afternoon.',
        'fName' => 'Full name',
        'fEmail' => 'Work email',
        'fCompany' => 'Company',
        'fRole' => 'Job title',
    ...
    'id' => [
        ...
        'thanksBody' => 'Kami akan mengonfirmasi kursi Anda melalui email dalam dua hari kerja, beserta petunjuk persiapan untuk siang itu.',
        'fName' => 'Nama lengkap',
        'fEmail' => 'Email kantor',
        'fCompany' => 'Perusahaan',
        'fRole' => 'Jabatan',
